...
<!-- files:start -->
- [`project-brief.md`](project-brief.md) - what the project is, why it exists, domain language
- [`architecture.md`](architecture.md) - stack, module boundaries, key decisions, gotchas
<!-- files:end -->
